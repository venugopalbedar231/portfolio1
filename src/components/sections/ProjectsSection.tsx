      ...
      >
        ...
        <div className="relative h-48 overflow-hidden">
          ...
          <div
            ...
            style={{
              background: `linear-gradient(to bottom, transparent 0%, ${project.color}20 50%, rgba(5,5,8,0.8) 100%)`,
            }}
          />
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-2 font-body text-sm text-text-secondary hover:text-neon-cyan transition-colors pb-1 border-b border-border hover:border-neon-cyan/50"
            >
              View all on GitHub
